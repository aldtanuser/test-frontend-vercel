...
<template>
  <div class="row" style="padding: 0; margin: 0;">
    ...
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
        <label class="col-md-6" for="radiusTubular">Radius Tubular</label>
        <input type="text" class="col-md-1" id="radiusTubular"
          v-model="receivedFocusedNodeData.properties.radiusTubular" />
      </div>
      <div class="input-row-col-2">
    ...
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
        <label class="col-md-6" for="segmentsTubular">Segments Tubular</label>
        <input type="text" class="col-md-1" id="segmentsTubular"
          v-model="receivedFocusedNodeData.properties.segmentsTubular" />
      </div>
      <div class="input-row-col-2">
        <label class="col-md-6" for="p">p</label>
        <input type="text" class="col-md-1" id="p" v-model="receivedFocusedNodeData.properties.p" />
      </div>
    </div>
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
        <label class="col-md-6" for="q">q</label>
        <input type="text" class="col-md-1" id="q" v-model="receivedFocusedNodeData.properties.q" />
      </div>
      <div class="input-row-col-2">
