...
<template>
  <div class="row" style="padding: 0; margin: 0;">
    ...
    <div class="input-row gap-2 d-flex justify-content-between">
      ...
      <div class="input-row-col-2">
        <label class="col-md-2" for="vertex-a">vertexA</label>
        <input type="text" class="col-md-1" id="vertex-a" v-model="receivedFocusedNodeData.properties['vertex-a']" />
      </div>
    </div>
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
        <label class="col-md-2" for="vertex-b">vertexB</label>
        <input type="text" class="col-md-1" id="vertex-b" v-model="receivedFocusedNodeData.properties['vertex-b']" />
      </div>
      <div class="input-row-col-2">
        <label class="col-md-2" for="vertex-c">vertexC</label>
        <input type="text" class="col-md-1" id="vertex-c" v-model="receivedFocusedNodeData.properties['vertex-c']" />
      </div>
    </div>
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
