  ...
  <div class="row" style="padding: 0; margin: 0;">
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
        <label class="col-md-6" for="id">Asset_Id</label>
        <input type="text" class="col-md-1" id="id" v-model="receivedFocusedNodeData.properties.id" />
      </div>
      <div class="input-row-col-2">
    ...
    <div class="input-row gap-2 d-flex justify-content-between">
      ...
      <div class="input-row-col-2">
        <label class="col-md-6" for="bottom">Bottom Radius</label>
        <input type="text" class="col-md-1" id="bottom" v-model="receivedFocusedNodeData.properties.radius_bottom" />
      </div>
    </div>
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
        <label class="col-md-6" for="top">Top Radius</label>
        <input type="text" class="col-md-1" id="top" v-model="receivedFocusedNodeData.properties.radius_top" />
      </div>
      <div class="input-row-col-2">
