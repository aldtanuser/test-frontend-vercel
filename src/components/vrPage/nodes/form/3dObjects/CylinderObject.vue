...
<template>
  <div class="row" style="padding: 0; margin: 0;">
    ...
    <div class="input-row gap-2 d-flex justify-content-between">
      ...
      <div class="input-row-col-2">
        <label class="col-md-6" for="segmentsRadial">Segments Radial</label>
        <input type="text" class="col-md-1" id="segmentsRadial"
          v-model="receivedFocusedNodeData.properties.segmentsRadial" />
      </div>
    </div>
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
      ...
      <div class="input-row-col-2">
        <label class="col-md-6" for="openEnded">Open Ended</label>
        <input type="text" class="col-md-1" id="openEnded" v-model="receivedFocusedNodeData.properties.openEnded" />
      </div>
    </div>
    <div class="input-row gap-2 d-flex justify-content-between">
      <div class="input-row-col-2">
