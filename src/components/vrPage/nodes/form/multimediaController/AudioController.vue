...
// properties id should be unique
...
<template>
  <div class="row" style="padding: 0; margin: 0;">
    ...
    <div class="input-row gap-2 d-flex justify-content-between">
      ...
      <div class="input-row-col-2">
        <label class="col-md-6" for="autoplay">Autoplay</label>
        <select class="col-md-8 select" id="autoplay" v-model="receivedFocusedNodeData.properties.autoplay">
          <option value="true">True</option>
          <option value="false">False</option>
        </select>
      </div>
