      ...
      <div class="modal-body d-flex flex-column mt-5">
        <div class="row">
          <div class="input-row gap-2 d-flex justify-content-between">
            ...
            <div class="input-row-col-2">
              <label class="col-md-2" style="padding-right: 5px" for="type">Event</label>
          ...
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              <label class="col-md-2" for="color">Colour</label>
              <input type="color" class="col-md-1" id="mcolor" v-model="receivedFocusedNodeData.properties.color" />
            </div>
            <div class="input-row-col-2">
            </div>
          </div>
