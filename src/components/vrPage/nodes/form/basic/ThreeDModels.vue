...
function scanDefaultDirectory() {
  fetch(`${baseUrl}/api/services/get-default-assets-content`)
    ...
    .then((data) => {
      ...
      console.log("defaultDirectoryContents.value", defaultDirectoryContents.value)
    })
    .catch((error) => {
      console.error("Error:", error);
    });
            ...
            <div class="row">
              <div class="input-row gap-2 d-flex justify-content-between">
                <div class="input-row-col-2">
                  ...
                  <select class="col-md-6 select" id="type" v-model="receivedFocusedNodeData.type">
                    <option value="gltf-model" selected>GLTF Model</option>
                    <option value="obj-model" selected>OBJ Model</option>
                  </select>
                </div>
                <div class="input-row-col-2">
              ...
              <form id="upload-form" enctype="multipart/form-data" method="post">
                <div class="custom-file-upload">
                  <input type="file" name="sampleFile" id="sampleFile"
                    accept=".gltf, .zip, .glb, .obj" style="display: none"
              ...
              <div class="input-row">
                <p class="col-md-12 default-assets-note" for="default-assets">
                  ...
                  below. Copy the asset name and paste it in the field below.<br /><span @click="handleRedirect('/assets-library/3d-models', $event)">Aldtan
