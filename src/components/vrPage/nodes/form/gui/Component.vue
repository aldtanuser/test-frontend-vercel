...
function saveModal() {
  receivedFocusedNodeData.id = receivedFocusedNodeData.properties.id;
  emits("formSubmitted");
  closeModal();
}
  ...
  <aside ref="sidebarRef" class="sidebar_container common-css-div" :class="isModalOpen && 'active'">
    <div class="form-content">
      <h1 class="form-heading">
        {{ receivedFormLabel.toString().split(":")[1] || 'Component' }}
      </h1>
        ...
        <div class="row justify-content-between text-left">
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              ...
              <input type="text" class="col-md-1" id="id" v-model="receivedFocusedNodeData.properties.name" />
            </div>
            <div class="input-row-col-2">
              <label class="col-md-2" for="color">Color</label>
              <input type="text" class="col-md-1" id="color" v-model="receivedFocusedNodeData.properties.color" />
            </div>
          </div>
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
          ...
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              <label class="col-md-2" for="jNames"> jNames</label>
              <input type="text" class="col-md-1" id="jNames" v-model="receivedFocusedNodeData.properties.jNames" />
            </div>
            <div class="input-row-col-2">
              <label class="col-md-2" for="jInit"> jInit</label>
              <input type="text" class="col-md-1" id="jInit" v-model="receivedFocusedNodeData.properties.jInit" />
            </div>
          </div>
        </div>
      </div>
