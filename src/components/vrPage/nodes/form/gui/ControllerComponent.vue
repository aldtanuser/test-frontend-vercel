...
var receivedControllerType = props.controllerType;
  ...
  <aside ref="sidebarRef" class="sidebar_container common-css-div" :class="isModalOpen && 'active'">
    <div class="form-content">
      ...
      <div class="modal-body d-flex flex-column mt-5">
        <div class="row">
          <!-- Change the form according to the selected Controller Component type -->
          <component :is="receivedControllerType" :focusedNodeData="focusedNodeData" />
        </div>
      </div>
