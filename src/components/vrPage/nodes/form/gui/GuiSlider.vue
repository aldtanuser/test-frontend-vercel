  ...
  <aside ref="sidebarRef" class="sidebar_container common-css-div" :class="isModalOpen && 'active'">
    <div class="form-content">
      <h1 class="form-heading">
        Edit {{ receivedFormLabel.toString().split(":")[1] || 'Gui Slider' }} Node
      </h1>
        ...
        <div class="row">
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              <label class="col-md-6" for="min">Min</label>
              <input type="number" class="col-md-1" id="min" v-model="receivedFocusedNodeData.properties.min" />
            </div>
            <div class="input-row-col-2">
              <label class="col-md-6" for="max">Max</label>
              <input type="number" class="col-md-1" id="max" v-model="receivedFocusedNodeData.properties.max" />
            </div>
          </div>
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              <label class="col-md-6" for="step">Step</label>
              <input type="number" class="col-md-1" id="step" v-model="receivedFocusedNodeData.properties.step" />
            </div>
            <div class="input-row-col-2">
              <label class="col-md-6" for="value">value</label>
              <input type="number" class="col-md-1" id="value" v-model="receivedFocusedNodeData.properties.value" />
            </div>
          </div>
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              <label class="col-md-6" for="width">width</label>
              <input type="number" class="col-md-1" id="width" v-model="receivedFocusedNodeData.properties.width" />
            </div>
            <div class="input-row-col-2">
              <label class="col-md-6" for="height">Height</label>
              <input type="number" class="col-md-1" id="height" v-model="receivedFocusedNodeData.properties.height" />
            </div>
          </div>
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
          ...
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              <label class="col-md-6" for="textSize">Text Size</label>
              <input type="number" class="col-md-1" id="textSize" v-model="receivedFocusedNodeData.properties.textSize" />
            </div>
            <div class="input-row-col-2">
          ...
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              ...
              <input type="color" class="col-md-1" id="handleColor" v-model="receivedFocusedNodeData.properties.handleColor" />
            </div>
            <div class="input-row-col-2">
              <label class="col-md-6" for="trackColor">Track Color</label>
              <input type="color" class="col-md-1" id="trackColor" v-model="receivedFocusedNodeData.properties.trackColor" />
            </div>
          </div>
          <div class="input-row gap-2 d-flex justify-content-between">
            <div class="input-row-col-2">
              <label class="col-md-6" for="fillColor">Fill Color</label>
              <input type="color" class="col-md-1" id="fillColor" v-model="receivedFocusedNodeData.properties.fillColor" />
            </div>
            <div class="input-row-col-2">
      ...
      <!-- <div class="modal-body d-flex flex-column">
        ...
        <!-- <h4 class="heading-tags">SliderThumb Properties</h4>
        <div class="modal-body d-flex flex-column">

          <div class="row">
            <div class="input-row gap-2 d-flex justify-content-between">
              <div class="input-row-col-2">
                <label class="col-md-6" for="heightthumb">Height</label>
                <input type="text" class="col-md-1" id="heightthumb"
                  v-model="receivedFocusedNodeData.properties.heightthumb" />
              </div>
              <div class="input-row-col-2">
                <label class="col-md-6" for="widththumb">Width</label>
                <input type="text" class="col-md-1" id="widththumb"
                  v-model="receivedFocusedNodeData.properties.widththumb" />
              </div>
            </div>
            <div class="input-row gap-2 d-flex justify-content-between">
              <div class="input-row-col-2">
                <label class="col-md-6" for="colorthumb">Color</label>
                <input type="color" class="col-md-1" id="colorthumb"
                  v-model="receivedFocusedNodeData.properties.colorthumb" />
              </div>
              <div class="input-row-col-2">
                <input type="text" class="col-md-1" id="srcthumb" v-model="receivedFocusedNodeData.properties.srcthumb"
